    ...
    for cue in cues:
        if re.search(keyword, cue, re.IGNORECASE):
            ...
            if timestamp_match:
                ...
                timestamp_range_formatted = f"from = {start_time}\nto = {end_time}\n"
...
# Example usage
vtt_file_path = r'D:\BSL_project\bsl_dataset\BOBSL\subtitles\subtitles\manually-aligned\5134749367588120522.vtt'
keyword = 'thank'
output_file_path = r'D:\BSL_project\bsl_dataset\scripting_result\timestamps_thanks_5134749367588120522_alternate.txt'
